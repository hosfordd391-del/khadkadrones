export const themes = {
  blue: {
    ...
    light: {
      ...
      accent: "oklch(0.50 0.18 235)",
      "accent-foreground": "oklch(0.98 0 0)",
      border: "oklch(0.92 0.008 235)",
      input: "oklch(0.92 0.008 235)",
      ring: "oklch(0.50 0.18 235)",
      "glow-color": "oklch(0.50 0.18 235 / 0.15)",
      "glow-color-strong": "oklch(0.50 0.18 235 / 0.25)",
    },
    dark: {
      ...
      "primary-foreground": "oklch(0.1 0.01 235)",
      ...
      accent: "oklch(0.65 0.18 235)",
      "accent-foreground": "oklch(0.1 0.01 235)",
      border: "oklch(0.2 0.015 235)",
      input: "oklch(0.2 0.015 235)",
      ring: "oklch(0.65 0.18 235)",
      "glow-color": "oklch(0.65 0.18 235 / 0.12)",
      "glow-color-strong": "oklch(0.65 0.18 235 / 0.22)",
    },
  },
  cyan: {
    name: "Cyan",
